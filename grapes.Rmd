...
addition2021$block = factor(addition2021$block)
addition2021$row = factor(addition2021$row)
addition2021$subsample = factor(addition2021$subsample)
merlot2020 = full_join(merlot2020,addition2021, 
                       by=c("Key","block","treatment","row","subsample"))
