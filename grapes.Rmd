...
# Bold any findings where the p-value is <0.05
...
MANOVA works best when the response variables are somewhat correlated but do not exhibit strong multicollinearity (which would be if they were over 90% correlated). For the 
