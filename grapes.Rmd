...
=======
library(survival)
>>>>>>> 98f28ba8c000f0238f1fd850ce8f9ada1cccf796
library(knitr)
...
uneq.var.mer19 <- apply(homosc.table.mer20, c(1,2), function(x){sum(x<0.05)})
...
```{r fig.cap="Distributions of values for"}
...
# Check out how many of the tests came back with a significant result
uneq.var.mer20 <- apply(homosc.table.mer19, c(1,2), function(x){sum(x<0.05)})
...
for (var in rownames(uneq.var.mer20)[rowSums(uneq.var.mer20)>0]) {
  ...
  plot(split(merlot2020[,which(colnames(merlot2020==var))],
